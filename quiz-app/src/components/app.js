// import './App.css';
import { TextField, Grid, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio, spacing } from '@mui/material'
      ...
      <Grid container direction={"column"} spacing={2}>
        ...
        <Grid item xs={6}>
          <FormControl component="fieldset">
            ...
            <RadioGroup aria-label="correct answer" name="correct answer" value={correctAns} onChange = {event => setCorrectAns(event.target.checked)}>
